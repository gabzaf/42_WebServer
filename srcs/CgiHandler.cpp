...
CgiHandler::CgiHandler(const HttpRequest &request, const std::string &scriptPath, const std::string &interpreterPath,
		const std::string &pathInfo) : _request(request), _scriptPath(scriptPath),
