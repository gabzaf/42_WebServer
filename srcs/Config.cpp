...
LocationConfig::LocationConfig()
    : autoindex(false), return_loc(std::make_pair(0, "")) {}
LocationConfig::~LocationConfig() {}

ServerConfig::ServerConfig()
    : port(80), host("0.0.0.0"), root("."), client_max_body_size(1000000) {}
ServerConfig::~ServerConfig() {}
...
void Config::handleSrvClientBodySize(std::stringstream &ss,
                                     ServerConfig &server) {
...
void Config::parseServer(std::ifstream &file, std::string &line) {
  ...
  static const std::string keys[] = {
      ...
      "client_body_size", "error_page", "cgi"};
  static const ServerDirectiveHandler handlers[] = {
      &Config::handleSrvListen,
      &Config::handleSrvHost,
      &Config::handleSrvServerName,
      &Config::handleSrvRoot,
      &Config::handleSrvClientBodySize,
      &Config::handleSrvErrorPage,
      &Config::handleSrvCgi};
...
void Config::parseLocation(std::ifstream &file, std::string &line,
                           ServerConfig &server) {
  LocationConfig loc;
  ...
  static const std::string keys[] = {"root",          "autoindex",    "index",
                                     "allow_methods", "return",       "cgi_ext",
                                     "cgi_path",      "upload_store", "cgi"};
  static const LocationDirectiveHandler handlers[] = {
      &Config::handleLocRoot,    &Config::handleLocAutoindex,
      &Config::handleLocIndex,   &Config::handleLocAllowMethods,
      &Config::handleLocReturn,  &Config::handleLocCgiExt,
      &Config::handleLocCgiPath, &Config::handleLocUploadStore,
